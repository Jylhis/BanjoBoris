	...
	draw: function() {
      ...
      //SHAKE!!
		...
		if( this.player ) {
			...
			x += 42;
		  this.font.draw( 'x ' + this.currentScore, x, y+10 );
...
blackscreen = ig.Game.extend({

	init:function(){
		img = new ig.Image( 'media/blackscreen.png' );
		timer = new ig.Timer(0.1);
	},

	update:function(){
		if(timer.delta()>0){
			ig.system.setGame( Intro1);
			return;
		}
		this.parent();
	},
...
Intro1 = ig.Game.extend({
	...
	draw:function(){
		this.parent;
		img.draw( width * 0.32, height * 0.15 );
...
Intro2 = ig.Game.extend({

	clearColor: "#000000",
	init:function(){

		img = new ig.Image( 'media/intro2.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
Intro3 = ig.Game.extend({

	clearColor: "#000000",
	init:function(){

		img = new ig.Image( 'media/intro3.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
Intro4 = ig.Game.extend({

	clearColor: "#000000",
	init:function(){

		img = new ig.Image( 'media/intro4.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
Intro5 = ig.Game.extend({

	clearColor: "#000000",
	init:function(){

		img = new ig.Image( 'media/intro5.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
Intro6 = ig.Game.extend({

	clearColor: "#000000",
	init:function(){

		img = new ig.Image( 'media/intro6.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
endScreen = ig.Game.extend({
	...
	init:function(){
		...
		img = new ig.Image( 'media/victory.png' );
		ig.input.bind( ig.KEY.SPACE, 'jump' );
		font = new ig.Font( 'media/fredoka-one.font.png' );
...
if( ig.ua.mobile ) {
	...
	myTouchButtons = new ig.TouchButtonCollection([
		...
		new ig.TouchButton( 'jump', {right: 128, bottom: 0}, 128, 128, buttonImage, 2 ),
